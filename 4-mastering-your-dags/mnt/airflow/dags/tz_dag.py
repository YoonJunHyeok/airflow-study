...
default_args = {
    'start_date': datetime(2024, 3, 29, 10, tzinfo=local_tz),
    'owner': 'Airflow',
...
with DAG(
    dag_id='tz_dag', 
    # schedule_interval="0 1 * * *", # tzinfo 쓰기 전에는 UTC로 매일 오전 1시에 scheduled
    schedule_interval="0 10 * * *", # local 타임으로 오전 10시에 scheduled
